...
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double {
    val x = sagenes * 48 + arshins * 16 + vershoks
    return x * 4.445 / 100
}
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    val x = initial + initial * 0.01 * percent
    val y = x * 0.01 * percent + x
    return y * 0.01 * percent + y
}
...
fun numberRevert(number: Int): Int {
    val x = (number % 10) * 100
    val y = number % 100 - number % 10
    val z = (number % 1000 - y - number % 10) / 100
    return z + y + x
}
